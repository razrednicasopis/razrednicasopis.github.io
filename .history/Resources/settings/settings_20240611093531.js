...
document.addEventListener('DOMContentLoaded', function () {
    function toggleMaintenancePopup(show, endTime) {
        ...
        const endTimeP = document.createElement('p'); // Create the paragraph element for end time
        endTimeP.id = 'maintenanceEndTime'; // Set the ID
        maintenancePopup.appendChild(endTimeP); // Append it to the popup content
        if (maintenancePopup) {
        ...
        try {
            ...
            if (docSnap.exists()) {
                ...
                if (data.maintenanceMode) {
                    ...
                    toggleMaintenancePopup(true, formattedEndTime);
                } else {
