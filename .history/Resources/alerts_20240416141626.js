...
const maintenanceStartTime = new Date("2024-04-16T14:10:00Z").getTime();
...
function displayMaintenanceWarning(timeLeft, unit) {
  document.getElementById("maintenance-message").innerHTML = `Dragi uporabniki! Strežniki Razrednega Časopisa bodo zaradi vzdrževanja nedosegljivi čez ${timeLeft} ${unit}. Prosimo, načrtujte uporabo strani v skladu s tem.`;
...
function calculateTimeLeft() {
  ...
  if (timeDifference > 0 && !notificationDisplayedThisMinute) {
    ...
    // Check if the current time matches any of the specified intervals
