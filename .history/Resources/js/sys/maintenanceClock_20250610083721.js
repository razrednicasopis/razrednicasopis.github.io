...
function showNoDataMessage() {
  document.getElementById('maintenanceStatus').innerHTML = `<h1 style="color:white;text-align:center;margin-top:100px;font-size:35px;">Ni trenutnih podatkov o naslednjem vzdrževanju.</h1>`;
...
function showActiveMaintenanceMessage() {
  document.getElementById('maintenanceStatus').innerHTML = `
    <h1 style="color: #ff5c5c; text-align: center; margin-top: 80px; font-size: 35px;">Vzdrževanje je trenutno aktivno.</h1>
    <p style="color: white; text-align: center; font-size: 20px;">Spletna stran je lahko začasno nedosegljiva ali nepopolno delujoča.</p>
  `;
  document.querySelector('.flip-clock').style.display = 'none';
}
...
function showUpcomingMaintenanceWarning() {
  document.getElementById('maintenanceStatus').innerHTML = `
    <h1 style="color: #fff34a; text-align: center; margin-top: 80px; font-size: 35px;">VZDRŽEVANJE SE BO KMALU PRIČELO</h1>
    <p style="color: white; text-align: center; font-size: 20px;">Spletna stran se pripravlja na začetek vzdrževalnega obdobja.</p>
  `;
  document.querySelector('.flip-clock').style.display = 'none';
}
