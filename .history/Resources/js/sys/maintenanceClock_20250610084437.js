...
function showNoDataMessage() {
  document.getElementById('maintenanceStatus').innerHTML = `<h1 style="color:white;text-align:center;;font-size:35px;">Ni trenutnih podatkov o naslednjem vzdrževanju.</h1>`;
