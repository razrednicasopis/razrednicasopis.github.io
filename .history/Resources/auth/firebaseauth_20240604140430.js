...
import { getFirestore, setDoc, doc, serverTimestamp, deleteDoc } from "https://www.gstatic.com/firebasejs/10.11.1/firebase-firestore.js";
  ...
  if (signUpBtn) {
    signUpBtn.addEventListener('click', async (event) => {
      ...
      try {
        ...
        // Attempt to delete the user and Firestore documents if an error occurs after user creation
        if (auth.currentUser) {
          ...
          try {
            ...
            console.error("Napaka pri brisanju uporabnika ali dokumentov po neuspešni registraciji:", deleteError);
          }
        }
      }
    });
