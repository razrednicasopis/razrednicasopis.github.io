...
import { getAuth, createUserWithEmailAndPassword, sendEmailVerification, signOut, onAuthStateChanged } from "https://www.gstatic.com/firebasejs/10.11.1/firebase-auth.js";
import { getFirestore, setDoc, doc, serverTimestamp } from "https://www.gstatic.com/firebasejs/10.11.1/firebase-firestore.js";
  ...
  if (signUpBtn) {
    signUpBtn.addEventListener('click', async (event) => {
      ...
      try {
        ...
        // Attempt to sign out the user if an error occurs during registration
        try {
          await signOut(auth);
        } catch (signOutError) {
          console.error("Napaka pri odjavi po neuspešni registraciji:", signOutError);
        }
      }
    });
  }
